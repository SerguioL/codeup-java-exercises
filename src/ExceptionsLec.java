...
public class ExceptionsLec {
    ...
    public void askForAnInteger(){
        ...
        try{
            ...
            System.out.println("Oh oh " + nfx.getMessage() + " there is no integer");
        } finally {
...
//            System.out.println("For that , I need integer between 0 and " + wordArrayList.size());
//        }catch (NullPointerException npe){
//            System.out.println("This Method ws not provided with a sentence to operate on");
//        }catch (IllegalAccessException) {
//            System.out.println("I think you just gave me a number in descending order.");
//        }finally {
